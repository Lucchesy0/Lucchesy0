...
🎯 Em busca de oportunidades de **estágio/trainee** em desenvolvimento
...
### 🛡️ Sistema de Portaria Remota
- **Stack**: React + Vite, Python (Backend)
- Interface moderna para controle de acesso e registro de visitas
- Implementação de autenticação e validação de dados

### 🏥 Plataforma de Gestão de Clínicas
- **Stack**: Node.js, MongoDB, React
- Sistema completo de agendamento de consultas
- Cadastro de pacientes, médicos e horários disponíveis

### 📊 Dashboards & BI
- **Stack**: Power BI, SQL, Python
- Desenvolvimento de relatórios e visualizações de dados
- Pipelines de extração e transformação de dados (ETL)
...
[![Portaria São Pedro](https://github-readme-stats.vercel.app/api/pin/?username=Lucchesy0&repo=Portaria-Sao-Pedro&theme=tokyonight)](https://github.com/Lucchesy0/Portaria-Sao-Pedro)
[![Plataforma Consultas](https://github-readme-stats.vercel.app/api/pin/?username=Lucchesy0&repo=Plataforma-Consultas-Backend&theme=tokyonight)](https://github.com/Lucchesy0/Plataforma-Consultas-Backend)
...
[![LinkedIn](https://img.shields.io/badge/-LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/lucas-luchesy-83890a259)
[![GitHub](https://img.shields.io/badge/-GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/Lucchesy0)
